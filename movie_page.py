...
class Waiting_Page(Toplevel):
    ...
    def configure_background(self):
        self.configure(bg="pink")  # Set the background color of the window
...
class movie_page(Frame):
    def __init__(self, parent, movie_dict):
        ...
        self.parent.title("Double click on the movie you want to watch and‍ Close the window when you are done.")
